...
// Verifica se veio categoria pela URL
...
<head>
  <meta charset="UTF-8">
  <title>Categoria <?= htmlspecialchars($categoria) ?></title>
...
<div class="banner-categoria">
  ...
  <p>Confira os produtos disponíveis para doação nesta categoria</p>
</div>
...
<div class="container">
  ...
  <div class="row g-4">
    <?php if ($result->num_rows > 0): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <p class="msg-vazia">Nenhum produto encontrado nesta categoria.</p>
    <?php endif; ?>
  </div>
...
- Verifica se a categoria foi enviada pela URL (?cat=).
- Busca no banco todos os produtos da categoria informada.
- Exibe um banner com o nome da categoria.
- Lista os produtos em cards usando Bootstrap.
- Cada card mostra imagem, nome, categoria e botão "Doar".
- Se não houver produtos, exibe uma mensagem informando.
- Possui botão para voltar à página principal (viva.php).
- Usa htmlspecialchars() para segurança dos dados exibidos.
*/
?>
