...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* ==================== FUNDO ==================== */
    body {
      background: url('img/fundo.jpeg') no-repeat center top;
    ...
    .btn-login:hover {
      ...
      box-shadow: 0 6px 20px rgba(224, 165, 60, 0.4);
    }
    ...
    <div class="container-fluid" id="nav-container">
      <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
        <a href="#" class="navbar-brand">
          <img id="logo" src="img/logo.jpg" alt="Doe.Fácil" width="150" height="150">
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbar-link">
          <div class="navbar-nav">
            ...
            <a href="conecte.php" class="nav-item nav-link active" id="Conecte-menu">Conecte</a>
...
<div class="login-wrapper">
  <div class="login-container">
    <img src="img/logo.jpg" alt="Doe.Fácil" />
    ...
    <p class="info-text">
      Ao entrar, você poderá acompanhar a porcentagem de doações feitas pelos usuários, garantindo mais transparência e confiança no site.
    </p>
...
- Página de login do site Doe.Fácil.
- Usa Bootstrap, Font Awesome e CSS personalizado.
- Menu fixo no topo com navegação do site.
- Fundo com imagem e efeito blur (glassmorphism).
- Formulário de login com email e senha.
- Envia os dados para "conexao.php" via POST.
- Layout responsivo, moderno e animado.
-->
